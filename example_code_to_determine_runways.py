...
def determine_runways(month, week):
    ...
    DATA_INPUT_DIR = os.path.join(DATA_DIR, "osn_"+ airport_icao + "_states_50NM_" + year + '_filtered_by_altitude')
...
def create_runways_files(month, week):
    ...
    DATA_INPUT_DIR1 = os.path.join(DATA_DIR, "osn_"+ airport_icao + "_states_50NM_" + year + '_filtered_by_altitude')
...
def main():
    ...
    for month in months:
        number_of_weeks = (4, 4)[month == '02' and not calendar.isleap(int(year))]
        #number_of_weeks = 1
