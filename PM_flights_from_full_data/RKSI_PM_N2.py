...
for week in ['1','2','3','4']:
    for rwy in ['_rwy15','_rwy16','_rwy33','_rwy34']:
        ...
        NODUN_lat, NODUN_lon = dms2dd("371110.10N 1272027.50E")
        ...
        ANYANG_lat, ANYANG_lon = dms2dd("372449.00N 1265542.10E")
        ...
        for flight_id, flight_df in states_df.groupby(level='flightId'):
            ...
            for seq, row in flight_df.groupby(level='sequence'):
                ...
                if (check_circle_contains_point(NODUN_circle_center, radius, Point(lon, lat))):
                    step = 1
                    #drop = False
                   # break
                if (check_circle_contains_point(ANYANG_circle_center, radius, Point(lon, lat))):
                    if step == 1:
                        drop = False
                        #print(seq)
                        break
