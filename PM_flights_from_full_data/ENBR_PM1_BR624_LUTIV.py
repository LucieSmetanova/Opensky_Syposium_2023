...
DATA_DIR = os.path.join(r"PATH\Data", airport_icao)
...
BR624_lat, BR624_lon = (60.477389,5.611536)
BR624_circle_center = Point(BR624_lon, BR624_lat)

BR625_lat, BR625_lon = (60.548308,5.779722)
BR625_circle_center = Point(BR625_lon, BR625_lat)

LUTIV_lat, LUTIV_lon = (60.535108,5.61315)
...
for flight_id, flight_df in states_df.groupby(level='flightId'):
    ...
    for seq, row in flight_df.groupby(level='sequence'):
        ...
        if (check_circle_contains_point(BR624_circle_center, radius, Point(lon, lat))):
            step = 1
            #print(seq)
        if (check_circle_contains_point(BR625_circle_center, radius, Point(lon, lat))):
            step = 1
            #print(seq)
...
filename = "PM_dataset_arrival_50NM_BR624_LUTIV.csv"
